public class IngredientesTester{
    ...
    public Map<String, Ingrediente> crearIngredientes(){
        ...
        ingredientes.put("Aceite", new Ingrediente("Aceite", "Grasa" /*otro tipo*/, new InfoNutricionalPeso(885, 0, 100, 12.81, 0, 0, 0, 2)));
        ingredientes.put("Huevo", new Ingrediente("Huevo", TipoIngrediente.HUEVO, new InfoNutricionalUnidad(84.6, 0.35, 6.3, 0.2, 6.6, 0.6, 0, 0.1))
                        .tieneAlergenos(Alergeno.HUEVO));
        ingredientes.put("Chorizo", new Ingrediente("Chorizo", TipoIngrediente.CARNE, new InfoNutricionalPeso(203, 5, 14.3, 4.6, 13.6, 0, 2, 800))
